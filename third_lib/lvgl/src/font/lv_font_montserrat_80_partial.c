 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --no-compress --stride 1 --align 1 --font Montserrat-Regular.ttf --symbols  0123456789:-+ --format lvgl -o lv_font_montserrat_80_partial.c
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_80_PARTIAL
#define LV_FONT_MONTSERRAT_80_PARTIAL 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 630, .adv_w = 489, .box_w = 22, .box_h = 6, .ofs_x = 4, .ofs_y = 19},
    {.bitmap_index = 696, .adv_w = 847, .box_w = 45, .box_h = 57, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1979, .adv_w = 462, .box_w = 20, .box_h = 57, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2549, .adv_w = 727, .box_w = 42, .box_h = 57, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3746, .adv_w = 722, .box_w = 42, .box_h = 57, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4943, .adv_w = 846, .box_w = 49, .box_h = 57, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 6340, .adv_w = 724, .box_w = 42, .box_h = 57, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7537, .adv_w = 780, .box_w = 43, .box_h = 57, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 8763, .adv_w = 754, .box_w = 42, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 9960, .adv_w = 817, .box_w = 45, .box_h = 57, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 11243, .adv_w = 780, .box_w = 43, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 12469, .adv_w = 271, .box_w = 9, .box_h = 43, .ofs_x = 4, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_80_partial = {
#else
lv_font_t lv_font_montserrat_80_partial = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_80_PARTIAL*/
